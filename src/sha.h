...
{
    template<typename T>
    T rotateLeft(T data, size_t amount)
    {
        return (data << amount) | (data >> ((sizeof(T) * 8) - amount));
    }
    template<typename T>
    T rotateRight(T data, size_t amount)
    {
    ...
    {
    public:
        static constexpr uint32_t constant[64] = {
    ...
    class SSHA512_t : SHA3
    {

    };
    class SSHA512_224 : SHA3
    {

    };
    class SSHA512_256 : SHA3
    {
